...
import { BuilderApp, type VertenteSystem } from '@/components/builder/BuilderApp';
...
export default function BuilderPage() {
  ...
  if (!system || !derived || !creation || !proficiencies) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16">
        <h1 className="font-serif text-3xl text-ink-50 mb-2">Builder indisponível</h1>
        <p className="text-ink-300">
          Dados de sistema ausentes em <code className="font-mono">data/meta/</code> ou{' '}
          <code className="font-mono">data/proficiencies/</code>.
        </p>
      </div>
    );
  }
  ...
  return <BuilderApp ctx={ctx} vertentes={vertentes} vertenteSystem={vertenteSystem} />;
}
